Logica y esquema del modulo inventario_sofware
=============================================

1. Objetivo del modulo
- El modulo `inventario_sofware` permite administrar dos grandes grupos de informacion:
  - software y licencias
  - sitios web, apps y clientes
- La portada principal es `inventario_sofware/index.php`.
- Las consultas rapidas se realizan desde `inventario_sofware/consulta_nueva.php`.
- El dashboard general se muestra en `inventario_sofware/dashboard.php`.
...
- El esquema sugerido del modulo se encuentra en:
  - `inventario_sofware/views/sql_sugerido_inventario_software.sql`

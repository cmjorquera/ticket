...
?>
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4"><div><h1 class="h3 mb-1">Editar software #<?= (int)$software['id_software'] ?></h1><p class="text-muted mb-0"><?= inventario_h($software['nombre_software']) ?> · <?= inventario_h($software['version_software']) ?></p></div><a href="ver_software.php?id_software=<?= (int)$software['id_software'] ?>" class="btn btn-primary inv-system-btn">Ver ficha</a></div>

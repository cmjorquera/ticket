...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="descargar_pdf.php?tipo=sitio_ficha&id_sitio=<?= (int)$sitio['id_sitio'] ?>" class="btn btn-danger inv-system-btn" target="_blank"><i class="bi bi-file-earmark-pdf me-1"></i>PDF</a>

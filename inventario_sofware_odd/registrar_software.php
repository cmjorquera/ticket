...
?>
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4"><div><h1 class="h3 mb-1">Registrar software</h1><p class="text-muted mb-0">Crea un registro de licencias, costo, responsable y cuentas asociadas.</p></div><a href="index.php" class="btn btn-secondary inv-system-btn">Volver</a></div>

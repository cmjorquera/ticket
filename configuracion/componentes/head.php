...
<head>
    ...
    <?php if (!empty($configuracionCss) && is_array($configuracionCss)): ?>
        <?php foreach ($configuracionCss as $cssConfiguracion): ?>
            <link href="<?php echo htmlspecialchars($assetPrefix . ltrim($cssConfiguracion, '/'), ENT_QUOTES, 'UTF-8'); ?>" rel="stylesheet">
        <?php endforeach; ?>
    <?php endif; ?>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO `beneficios_principales`(`nombre`, `imagen`, `url`) 
            VALUES ('$nombre', '$relativeFilePath', '$url')";

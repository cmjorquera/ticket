    ...
    tooltipTriggerList.forEach(function (el) {
        new bootstrap.Tooltip(el);
                                                        ...
                                                        <?php 
                                                            ...
                                                            if ($row['id_estado'] == 3) {
                                                                if ($diasRestantes == 0 || $diasRestantes == 1) {
                                                                    ...
                                                                    $diasTitulo = htmlspecialchars($diasRestantes) . ' dias';
                                                                     ...
                                                                     $idContenedor = 'estrellas_' . $idTicket;
                                                                        ...
                                                                        $diasDetalle = 'Pendiente inicio';
                                                                                ...
                                                                                if ($row['dias_administrador_estima'] == 0) {
                                                                                    ...
                                                                                    $diasTitulo = htmlspecialchars($row['dias_administrador_estima']);
                                                    ...
                                                    <td class="celda-calificacion" style="<?= $estiloCelda ?>">
                                                     ...
                                                     if ($idEstado == 5) {
                                                    if ($usuarioCalifico == 1) {
                                                        echo '<i class="status-icon resolved fas fa-check-circle" style="color: green;"></i> Usuario calificó el ticket';
                                                    } else {
                                                        $idContenedor = 'estrellas_' . $idTicket;

...
<form id="formInventario" action="<?= inventario_h($action) ?>" method="post" class="inv-form">
    ...
    <div class="accordion inv-accordion" id="accordionSitio">
        <div class="accordion-item">
            <h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#datosSitio"><span class="inv-accordion-step">1</span><span><strong class="d-block">Datos del sitio</strong><small class="text-muted">Colegio, responsable, tipo, URL, hosting y estado</small></span></button></h2>

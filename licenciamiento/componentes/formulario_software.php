...
<form id="formInventario" action="<?= inventario_h($action) ?>" method="post" class="inv-form">
    ...
    <div class="accordion inv-accordion" id="accordionSoftware">
            ...
            <div id="datosSoftware" class="accordion-collapse collapse show" data-bs-parent="#accordionSoftware"><div class="accordion-body"><div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                        ...
                        <button type="button" class="btn btn-primary inv-system-btn btn-sm" id="btnAgregarTipoUsuario" data-endpoint="ajax/guardar_tipo_usuario.php">
            ...
            <div id="datosSensibles" class="accordion-collapse collapse" data-bs-parent="#accordionSoftware"><div class="accordion-body">
                <?php if (!empty($datosSensiblesCatalogo)): ?>
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                        ...
                        <button type="button" class="btn btn-primary inv-system-btn btn-sm" id="btnAgregarDatoSensible" data-endpoint="ajax/guardar_dato_sensible.php">
        ...
        <div class="accordion-item">
            ...
            <div id="datosAlmacenamiento" class="accordion-collapse collapse" data-bs-parent="#accordionSoftware"><div class="accordion-body">
                <div class="d-flex justify-content-between align-items-center mb-3"><h6 class="mb-0">Personas o cuentas relacionadas</h6><button type="button" class="btn btn-primary inv-system-btn btn-sm" id="btnAgregarAlmacenamiento">Agregar fila</button></div>
    ...
    <div class="d-flex justify-content-end gap-2 mt-4"><a href="index.php" class="btn btn-secondary inv-system-btn">Volver</a><button type="submit" class="btn btn-primary inv-system-btn"><?= $modo === 'editar' ? 'Actualizar software' : 'Guardar software' ?></button></div>
</form>

...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="descargar_pdf.php?tipo=software_ficha&id_software=<?= (int)$software['id_software'] ?>" class="btn btn-danger btn-icon-split inv-system-btn" target="_blank"><span class="icon"><i class="bi bi-file-earmark-pdf"></i></span><span class="text">PDF</span></a>
        <a href="ficha_qr.php?tipo=software&id=<?= (int)$software['id_software'] ?>" class="btn btn-secondary inv-system-btn" target="_blank"><i class="bi bi-box-arrow-up-right me-1"></i>Ficha QR</a>
        <a href="editar_software.php?id_software=<?= (int)$software['id_software'] ?>" class="btn btn-primary inv-system-btn">Editar</a>
        <a href="index.php" class="btn btn-secondary inv-system-btn">Volver</a>
    </div>
</div>
<div class="row g-4">
    <div class="col-lg-8">
        ...
        <div class="card shadow-sm border-0 inv-panel mb-4">
            <div class="card-body text-center">
                ...
                <div class="d-grid gap-2">
                    <a href="qr_codigo.php?tipo=software&id_software=<?= (int)$software['id_software'] ?>" class="btn btn-secondary inv-system-btn" target="_blank">Ver QR</a>
                    <a href="ficha_qr.php?tipo=software&id=<?= (int)$software['id_software'] ?>" class="btn btn-primary inv-system-btn" target="_blank">Abrir ficha QR</a>
                </div>
            </div>
        </div>

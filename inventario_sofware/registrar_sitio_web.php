...
?>
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4"><div><h1 class="h3 mb-1">Registrar sitio web</h1><p class="text-muted mb-0">Crea una ficha para web, app o cliente conectado a servidor.</p></div><a href="index.php" class="btn btn-light border">Volver</a></div>

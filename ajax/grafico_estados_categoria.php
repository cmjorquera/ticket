...
try {
    ...
    responder_json(['ok' => true, 'data' => $dashboard->obtenerGraficoCategorias($perfil)]);
} catch (Throwable $ex) {
    responder_json(['ok' => false, 'mensaje' => 'No fue posible cargar el gráfico por categoría.'], 500);
}

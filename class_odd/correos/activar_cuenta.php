        ...
        <div class="mail-frame">
            ...
            <div class="mail-card">
                <div style="text-align:center;">
                    <span class="mail-badge">Sistema de Gestión</span>
                    <h1 class="mail-title">Bienvenido al sistema</h1>
                    <div class="mail-divider"></div>
                    <div class="mail-intro">
                        Activa tu cuenta para comenzar a utilizar la plataforma y acceder a las distintas herramientas de gestión, seguimiento y control de información.
                    </div>
                </div>
                ...
                <div class="mail-section">
                    ...
                    <p class="mail-text">
                        Tu cuenta fue creada correctamente. A partir de ahora podrás acceder al sistema y utilizar sus herramientas para gestionar solicitudes, revisar información relevante y mantener seguimiento de los distintos procesos disponibles en la plataforma.
                    </p>

                    <p class="mail-text">
                        El sistema está diseñado para centralizar la información, facilitar el seguimiento de actividades y entregar una visión clara del estado de cada proceso dentro de la plataforma.
                    </p>
                </div>
                    ...
                    <tr>
                        <td width="50%">
                            <div class="mail-panel mail-panel-accent-green">
                                ...
                                <p class="mail-panel-text">
                                    Revisa el estado y avance de tus solicitudes o procesos dentro del sistema de forma clara y organizada.
                                </p>
                            </div>
                        </td>
                        <td width="50%">
                            <div class="mail-panel mail-panel-accent-blue">
                                <p class="mail-panel-title blue">Gestión</p>
                                <p class="mail-panel-text">
                                    Accede a un espacio centralizado para registrar información, consultar datos y mantener historial de tus actividades.
                                </p>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="mail-cta-wrap">
                    <p class="mail-text">
                        Para comenzar, haz clic en <strong>Activar Cuenta</strong>. Desde ahí podrás crear tu contraseña y acceder al sistema.
                    </p>
                ...
                <div class="mail-section">
                    <div class="mail-panel">
                        ...
                        <table class="mail-data" role="presentation">
                            ...
                            <tr>
                                <td class="mail-data-label">Área de trabajo</td>
                ...
                <p class="mail-note">
                    <a class="mail-link" href="{enlaceActivacion}">{enlaceActivacion}</a>
                </p>
            </div>

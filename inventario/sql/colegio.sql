...
-- Tiempo de generación: 12-06-2026 a las 11:51:03
...
CREATE TABLE `colegio` (
  ...
  `color_principal` varchar(20) DEFAULT NULL COMMENT 'Color primario del colegio (hex, ej: #1D4ED8)',
  `color_secundario` varchar(20) DEFAULT NULL COMMENT 'Color secundario del colegio (hex)',
  `color_terciario` varchar(20) DEFAULT NULL COMMENT 'Color terciario del colegio (hex)',
  `color_cuaternario` varchar(20) DEFAULT NULL COMMENT 'Color cuaternario del colegio (hex)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

-- Para aplicar en base de datos existente:
-- ALTER TABLE `colegio`
--   ADD COLUMN `color_principal`   VARCHAR(20) DEFAULT NULL AFTER `estado`,
--   ADD COLUMN `color_secundario`  VARCHAR(20) DEFAULT NULL AFTER `color_principal`,
--   ADD COLUMN `color_terciario`   VARCHAR(20) DEFAULT NULL AFTER `color_secundario`,
--   ADD COLUMN `color_cuaternario` VARCHAR(20) DEFAULT NULL AFTER `color_terciario`;

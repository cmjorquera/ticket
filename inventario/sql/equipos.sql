...
-- Tiempo de generación: 12-06-2026 a las 09:28:38
...
(75, 2492, 11, 2492, 'LAPTOP-92BTC0P8', 'Asus', 'Vivobook Go E1504FA', 'T9N0CV15T954396', 'Notebook', 'PC-T9N0CV15T954396', 1),
(76, 2492, 11, 0, 'CARLOS-GUAJARDO', 'Asus', 'Vivobook Go E1504FA', 'T9N0CV15T93639E', 'Notebook', 'PC-T9N0CV15T93639E', 1);
...
--
ALTER TABLE `equipos`
  MODIFY `id_equipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
COMMIT;

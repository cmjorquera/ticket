...
foreach ($monitor['fotos'] as $foto) {
    if ($foto['principal'] && !$fotoPrincipal) {
        $fotoPrincipal = $foto;
    } else {
        $fotosGaleria[] = $foto;
    }
...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    <div>
        <h1 class="h3 mb-1"><?= inventario_h($monitor['nombre_monitor']) ?></h1>
    ...
    <div class="d-flex gap-2">
        <a href="editar_monitor.php?id_monitor=<?= $idMonitor ?>" class="btn btn-outline-primary">
    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow-sm border-0 inv-panel mb-4">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Colegio</span>
                        <strong><?= inventario_h($monitor['nom_colegio']) ?></strong>
                    </div>
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Estado</span>
                        <?= $inventario->renderBadgeEstado(
                            $monitor['id_estado'],
                            $monitor['nombre_estado'] ?? '',
                            $monitor['color_badge'] ?? 'dark'
                        ) ?>
                    </div>
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Ubicación actual</span>
                        <strong>
                            <?php
                    ...
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Usuario asignado</span>
                        <strong><?= inventario_h($monitor['usuario_asignado'] ?: 'Sin asignar') ?></strong>
                    </div>
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Registrado por</span>
                        <strong><?= inventario_h($monitor['nombre_usuario_registra'] ?: '-') ?></strong>
                    </div>
                    <div class="col-md-4">
                        <span class="text-muted d-block small">Código interno</span>
                        <strong><?= inventario_h($monitor['codigo_interno'] ?: '-') ?></strong>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <ul class="list-unstyled inv-list">
                            ...
                            <li><span>Tamaño</span><strong><?= inventario_h($monitor['tamano_monitor'] ?: '-') ?></strong></li>
                            <li><span>Resolución</span><strong><?= inventario_h($monitor['resolucion_monitor'] ?: '-') ?></strong></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="list-unstyled inv-list">
                    ...
                    <div class="col-12">
                        <span class="text-muted d-block small">Observación</span>
        ...
        <div class="card shadow-sm border-0 inv-panel mb-4">
            <div class="card-body">
                ...
                <ul class="list-unstyled inv-list">
                    ...
                    <li><span>Observación</span><strong><?= inventario_h($compra['observacion']) ?></strong></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0 inv-panel mb-4">
            <div class="card-body p-2">
                <div class="inv-ver-foto-principal-wrap">
                    <img src="/<?= htmlspecialchars(ltrim($fotoPrincipal['ruta_foto'], '/'), ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="inv-photo-grid">
                    <?php foreach ($fotosGaleria as $foto): ?>
                        <div class="inv-photo-item">
                            <img src="/<?= htmlspecialchars(ltrim($foto['ruta_foto'], '/'), ENT_QUOTES, 'UTF-8') ?>"

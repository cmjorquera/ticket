...
-- Tiempo de generación: 09-07-2026 a las 09:57:41
...
(341, 76, '', '', '', 0, '', 1),
(343, 78, '', '', '', 0, '', 1),
(347, 77, 'Dell P2219H', 'MON-001', 'SN-MON-001', 22, '1920x1080', 1),
(348, 80, 'GSM E2251', '', '', 0, '1920x1080', 1),
(349, 80, 'AUO', '', '', 0, '1920x1080', 2),
(352, 64, '()', 'CMN161A', '', 16, '1920 x 1080', 1),
(353, 64, 'S24F350 (Samsung)', 'SAM0D20', 'H4ZH800057', 23, '1920 x 1080', 2),
(354, 69, '()', 'BOE08E2', '', 15, '1920 x 1080', 1),
(355, 69, '', '', '', 0, '', 2),
(356, 67, 'S22A33x (Samsung)', 'SAM7122', 'H4TTC00365', 22, '1920 x 1080', 1),
(357, 67, '()', 'AUO499F', '', 15, '1920 x 1080', 2),
(358, 279, '3200 MHz', '', '', 0, '', 1),
(359, 280, '3200 MHz', '', '', 0, '', 1);
...
--
ALTER TABLE `equipo_monitor`
  MODIFY `id_monitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=360;

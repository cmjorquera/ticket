                                        ...
                                        <div class="card-header d-flex justify-content-between align-items-center py-3">
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                              ...
                                              <li><a class="dropdown-item" href="#" onclick="generarGraficoTicket('tecnico')">Técnico</a></li>
...
<script>
  ...
  new Chart(ctxColegios, {
    type: 'bar',
    data: {
      labels: ['Cordillera', 'Tabancura', 'Los Andes', 'Los Alerces', 'Huelén'],
      datasets: [{
        label: 'Tickets',
...
<script>
  ...
  alert("Función para generar y descargar el informe PDF");
  // Aquí iría la lógica para generar el PDF (usando jsPDF o fetch a backend PHP)
}

function descargarExcel() {
  alert("Función para generar y descargar el Excel");
  // Aquí podrías usar SheetJS o simplemente redirigir a un .php que genere Excel
}

                ...
                <thead>
                    <tr>
                        <th style="text-align:center;padding-bottom:25px" colspan="4">
                            <p style="font-size:22px;margin-bottom:0;margin-top:15px;font-weight:bold">¡Ticket Cerrado!</p>
                            <hr style="width:60px;border:2px solid #ccff5f">
                            <p style="font-size:20px;margin-bottom:20px">Gracias por confiar en Nosotros </p>
                            <span style="background:#1f2c4b;padding:10px 30px;border-radius:20px;color:#ccff5f;font-size:15px;text-transform:uppercase;font-weight:normal">N° de Ticket: <span style="font-weight:bold">A-0{codigo}</span></span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td style="text-align:center;width:15%"><img alt="date" width="30px" style="margin-bottom:10px" src="https://qa.seduc.cl/sistema/sistema_ticket/imagenes/calendar.png"></td>
                        <td style="font-size:14px;text-align:left;">
                            <p style="margin:0;text-transform:uppercase;font-weight:bold">Fecha de Cierre</p>
                            <p style="margin-top:0">{fecha}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;width:15%"><img alt="time" width="30px" style="margin-bottom:10px" src="https://qa.seduc.cl/sistema/sistema_ticket/imagenes/clock.png"></td>
                        <td style="font-size:14px;text-align:left;">
                            <p style="margin:0;text-transform:uppercase;font-weight:bold">Hora de Cierre</p>
                            <p style="margin-top:0">{hora}</p>
                        </td>
                        <td style="text-align:center;width:15%"><img alt="technician" width="30px" style="margin-bottom:10px" src="https://qa.seduc.cl/sistema/sistema_ticket/imagenes/support.png"></td>
                        <td style="font-size:14px;text-align:left;">

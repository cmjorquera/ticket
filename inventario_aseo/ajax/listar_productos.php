...
try {
    $filtros = [
        ...
        'activo' => isset($_GET['activo']) && $_GET['activo'] !== '' ? (int) $_GET['activo'] : '',
        'busqueda' => trim((string) ($_GET['busqueda'] ?? '')),
    ];

    $productos = $inventario->listarProductos($filtros);
    ...
    echo json_encode(['ok' => false, 'mensaje' => 'Error al listar productos: ' . $e->getMessage()], JSON_UNESCAPED_UNICODE);
}
